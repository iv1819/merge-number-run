...
namespace Funzilla
{
	internal class OptimizedScrollViewY : MonoBehaviour
	{
		...
		internal void Init(int itemCount)
		{
		...
		{
			_nItems = itemCount;
			scroll.content.sizeDelta = new Vector2(0, _nItems * _itemSize + padding * 2);
		}
		...
		private void OnScrolled()
		{
			...
			var y = scroll.content.anchoredPosition.y - padding;
			var iMax = _nItems - 1;
